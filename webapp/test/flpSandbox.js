		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Log de recepción y aprobación ",
									"targetURL": "#geoaprobacionlog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"geoaprobacionlog-display": {
								"semanticObject": "geoaprobacionlog",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=geo.aprobacionlog",
									"url": sap.ui.require.toUrl("geo/aprobacionlog")
								}
							}
						}
					}
